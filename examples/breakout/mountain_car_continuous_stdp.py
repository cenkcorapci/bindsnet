...
from bindsnet.pipeline.action import select_tanh

# Build network.
network = Network(dt=1.0)

# Layers of neurons.
inpt = Input(shape=[2], traces=True)
middle = LIFNodes(n=20, traces=True)
out = LIFNodes(n=1, refrac=0, traces=True)
...
environment = GymEnvironment("MountainCarContinuous-v0")
environment.reset()
